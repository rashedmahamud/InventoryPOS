...
public partial class Accounts_AddIncomeCategory : System.Web.UI.Page
{
    ...
    public void CategoryListDataBind()
    {
        ...
        SqlCommand cmd = new SqlCommand("Select *from Income_Category where  Branch_ID='" + ShopId.ToString() + "'", con);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Income_Category_Insert", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Income_Category", TextBox1.Text);
