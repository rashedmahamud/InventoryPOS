...
public partial class Accounts_BankDeposit : System.Web.UI.Page
{
    ...
    public void CategoryListDataBind()
    {
        ...
        SqlCommand cmd = new SqlCommand("Select *from Bankdeposit where  Branch_ID='" + ShopId + "'", con);
        cmd.CommandType = CommandType.Text;
        con.Open();
      ...
      protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Bankdeposit_Insert", cn);
