...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   ...
   <div style="width:100%">
          <div class="note note-primary note-shadow">
                    <asp:button id="btnBack" runat="server" style="padding-top:5px;margin-top: 15px;" class="btn btn-warning btn-xs"   Text="Back"
                OnClientClick="JavaScript: window.history.back(1); return false;">
                </asp:button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| Sales | Take Due Payment
          </div>
                    ...
                    <div class="panel-heading">
                        <div >
                            <div class="col-md-4 pull-left" >
                                ...
                                <asp:TextBox ID="TextBox1" runat="server" ForeColor="Black" OnTextChanged="TextBox1_TextChanged" AutoPostBack="true"></asp:TextBox>
                                <asp:Button ID="Button1" runat="server" ForeColor="Black" Text="Search" OnClick="Button1_Click" />
                            </div>
                            <div class="col-md-4 text-center"  style="text-align:left; top: 0px; left: 0px; width: 148px;" >
                                    Receiveable
                            </div>
