...
public partial class Sale_NewSale : System.Web.UI.Page
{
    List<string> lv = new List<string>();

    string ConnectionString = ConfigurationManager.ConnectionStrings["PointofSaleConstr"].ConnectionString;
    DataTable tableNewSales = new DataTable();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
          ...
          //  ItemsListDataBind(DDLCategory.Text);
            ...
            tableNewSales.Columns.Add("Code", typeof(string));
            tableNewSales.Columns.Add("Item Name", typeof(string));
            tableNewSales.Columns.Add("Qty", typeof(string));
            tableNewSales.Columns.Add("Price", typeof(string));
            tableNewSales.Columns.Add("Disc%", typeof(string));
            tableNewSales.Columns.Add("Total", typeof(string));
            Session["valuenewsales"] = tableNewSales;           
        }    
    ...
    protected void btn_Goclick(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            DataTable dt = (DataTable)Session["valuenewsales"];
   ...
   // double pricetotal = 0;
    ...
    protected void SaveSalePaymentInfo()
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("@trxtype",     "sales");
    ...
    //END Point - Sales Completed and Move to ----------------- >>>>>>>>>>> Sales invoice Print Page
