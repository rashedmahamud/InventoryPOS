...
public partial class Accounts_Quote : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < gvDetails.Rows.Count; i++)
        {
            ...
            QuotationItemList.Add(createInvoice);
    ...
    protected void SaveSaleItem()
    {
        try
        {
            ...
            for (int i = 0; i < gvDetails.Rows.Count; i++)
            {
                ...
                SqlConnection cn = new SqlConnection(ConnectionString);
                SqlCommand cmd = new SqlCommand("SP_POS_Insert_SalesItemsQuote", cn);
    ...
    protected void SaveSalePaymentInfo()
    {
        ...
        try
        {
            ...
            SqlConnection cn = new SqlConnection(ConnectionString);
            SqlCommand cmd = new SqlCommand("SP_POS_Insert_SRsalesPaymentQuote", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cn.Open();
