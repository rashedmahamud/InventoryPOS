...
public partial class Customers_NewOrder_Customer : System.Web.UI.Page
{
    ...
    protected void btn_Goclick(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Item is not available')", true);
        }
   ...
   // double pricetotal = 0;
    ...
    protected void SaveSalePaymentInfo()
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("@CustID",      Request.Cookies["InventMgtCustomerCookies"]["ID"].ToString());
            cmd.Parameters.AddWithValue("@CustName",    Request.Cookies["InventMgtCustomerCookies"]["CustName"].ToString());
            cmd.Parameters.AddWithValue("@CustContact", Request.Cookies["InventMgtCustomerCookies"]["CustPhone"].ToString());
            ...
            cmd.Parameters.AddWithValue("@ShopId",      "SYS89");
            cmd.Parameters.AddWithValue("@ServedBy",    Request.Cookies["InventMgtCustomerCookies"]["ID"].ToString());
            cmd.ExecuteNonQuery();
            cn.Close();
        }
        catch
    ...
    protected void bntPay_click(object sender, EventArgs e)
    {
      ...
      //  Session["customer"] = DDLCustname.Text;
        Response.Redirect("~/Customers/Order_Invoice_Customer.aspx"); 
    }
