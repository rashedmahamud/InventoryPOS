...
public partial class Customers_Orders_history  : System.Web.UI.Page
{
    ...
    public void ItemsListDataBind()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("[SP_INV_DataBind_OrderList_CustomerPanel]", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@custID", Request.Cookies["InventMgtCustomerCookies"]["ID"]);
            cn.Open();
