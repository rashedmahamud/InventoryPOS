...
public partial class Customers_ProfilePageCustomer : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UserID",          Request.Cookies["InventMgtCookies"]["UserID"].ToString());
