...
public partial class Customers_Purchase_InvoiceCustomer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                this.Title = "MyPurchase_Invoice_" + Session["invoice"].ToString();
                SystemInfo();
                ItemsListDataBind();
                paymentListDataBind();
                InvoiceInfo();  
    ...
    public void InvoiceInfo()
    {
        try
        {
            ...
            if (rd.HasRows)
            {
                ...
                lblpayType.Text = rd["payType"].ToString();
               ...
               // lbldeliveryAddress.Text = rd["shippingaddress"].ToString();
                ...
                lbldate.Text = rd["ordedate"].ToString(); 
            }
            cn.Close();
        }
        catch
