<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" CodeFile="Purchase_Invoice.aspx.cs" Inherits="Purchase_module_Purchase_Invoice" %>
...
<div   class="col-lg-9 col-lg-offset-1">
    ...
    <div  id="wrapper" style="text-align:left">
      <div  id="HeaderInfo" style="text-align:left;padding-left:15px">
                 <table class="style1" style="width:714px; height: 112px;">
                    <tr>
                         <td>
