   ...
   protected void  ImageButton1_Click(object sender, EventArgs e)
    ...
    public void CategoryDDLDataBind()
    {
        try
        {
            ...
            cn.Open();
            cmd.CommandText = "Select ItemCategory from tbl_Category  where  ShopID='" + Label11.Text + "'  and Status=1";
    ...
    protected void txtItemSearch_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            string Total = dtable.Rows[0].ItemArray[3].ToString();
            string image = dtable.Rows[0].ItemArray[4].ToString();
