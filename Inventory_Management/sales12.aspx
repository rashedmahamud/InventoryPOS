                ...
                <asp:Label ID="l1" Visible="false" runat="server" Text="Label"></asp:Label>
                    <div class="panel panel-primary"  > 
                            <header class="panel-heading" style="background-color:#00395d" >
                                <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="Return Sales" PostBackUrl="Salesregister.aspx" />
       ...
       <div class="divTableCell" style="width:17%">
            <table style="vertical-align:top;width:100%;height:100%" >
                  ...
                  <tr >
                                               ...
                                               <tr >
                                                   <td>    
                                                       <asp:Label ID="lblCustID" runat="server" Visible="true" Font-Size="11px" ForeColor="Black" Text="00"></asp:Label>
                  ...
                  <tr>
                                                                   <td style="vertical-align:middle">
                                                                       <img src="logo.jpeg"  style="width:100%;height:46%"/>
                                                                   </td>
