<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" Inherits="Accounts_BankDeposit" Codebehind="BankDeposit.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 ...
 <%--<div class="col-lg-8">--%>
       <div class="panel panel-default"  >
            ...
            <asp:Button ID="btnCategoryLink" class="btn btn-success btn-xs"  runat="server"  ValidationGroup="vlgp123"  Text="Bank Deposit" onclick="btnCategoryLink_Click" />     
           <span  style="padding-left:380px" class="fa fa-list"> </span> Bank Deposit 
           </div>
...
<asp:Panel ID="pnlpopupAddCategoryView"  class="panel panel-primary"  runat="server" BackColor="White" style="display:none"  Width="30%" DefaultButton="btnSubmit"> 
    ...
    <div class="panel-body">    
        ...
        <br />    
         ...
         <br /> 
         <asp:Label ID="Label3" runat="server" Font-Size="12px"  Text="Deposit Date"></asp:Label>
         ...
         <br /> 
         <asp:Label ID="Label6" runat="server" Font-Size="12px"  Text="Depositor"></asp:Label>
