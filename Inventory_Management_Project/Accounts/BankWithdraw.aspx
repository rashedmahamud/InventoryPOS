<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" Inherits="Accounts_BankWithdraw" Codebehind="BankWithdraw.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 ...
 <%--<div class="col-lg-8">--%>
       <div class="panel panel-default"  >
            ...
            <asp:Button ID="btnCategoryLink" class="btn btn-success btn-xs"  runat="server"  ValidationGroup="vlgp123"  Text="Bank Withddrawn" onclick="btnCategoryLink_Click" />     
           <span  style="padding-left:380px" class="fa fa-list"> </span> Bank Withddrawn 
           </div>
...
<asp:Panel ID="pnlpopupAddCategoryView"  class="panel panel-primary"  runat="server" BackColor="White" style="display:none"  Width="30%" DefaultButton="btnSubmit"> 
    ...
    <div class="panel-body">    
                                            ...
                                            <asp:Label ID="Label4" runat="server" Font-Size="12px"  Text="Bank Name"></asp:Label>
                                             <asp:DropDownList ID="DropDownList1" hight="50px"  runat="server"></asp:DropDownList>
        <br /><br />

                      <asp:Label ID="Label2" runat="server" Font-Size="12px"  Text="Account_Type"></asp:Label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" ValidationGroup="vlpg43"   ControlToValidate="TextBox1" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>                     
                                             <asp:DropDownList ID="DropDownList2" hight="50px"  AutoPostBack="true" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" runat="server"></asp:DropDownList>
        <br />  <br />  
                  <asp:Label ID="Label5" runat="server" Font-Size="12px"  Text="Account Number "></asp:Label>
                        <asp:TextBox  ID="TextBox1"  ToolTip="Account Number" class="form-control"  ValidationGroup="vlpg43" runat="server"></asp:TextBox>
        <br />    
         <asp:Label ID="Label1" runat="server" Font-Size="12px"  Text="Account Name"></asp:Label>
                        ...
                        <asp:TextBox  ID="TextBox2"  ToolTip=" Account Name" class="form-control"  ValidationGroup="vlpg43" runat="server"></asp:TextBox>
         <br /> 
         <asp:Label ID="Label3" runat="server" Font-Size="12px"  Text="Withdrawn Date"></asp:Label>
         ...
         <br /> 
         <asp:Label ID="Label6" runat="server" Font-Size="12px"  Text="Withdrawer"></asp:Label>
                        ...
                        <asp:TextBox  ID="TextBox4"  ToolTip="Depositor " class="form-control"  ValidationGroup="vlpg43" runat="server"></asp:TextBox>
         <br /> 
         ...
         <br /> 
         <asp:Label ID="Label8" runat="server" Font-Size="12px"  Text="Withdrawn Type"></asp:Label>
        ...
        <asp:Label ID="Label9" runat="server" Font-Size="12px"  Text="Brach ID"></asp:Label>
         ...
         <asp:Label ID="Label10" runat="server" Font-Size="12px"  Text="Description"></asp:Label>
                        ...
                        <asp:TextBox  ID="TextBox7"  ToolTip="Description" class="form-control"  ValidationGroup="vlpg43" runat="server"></asp:TextBox>
         <br />
