<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" Inherits="Accounts_Expenses" Codebehind="Expenses.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 ...
 <%--<div class="col-lg-8">--%>
       <div class="panel panel-default"  >
            ...
            <asp:Button ID="btnCategoryLink" class="btn btn-success btn-xs"  runat="server"  ValidationGroup="vlgp123"  Text="Add Expenses" onclick="btnCategoryLink_Click" />     
           <span  style="padding-left:380px" class="fa fa-list"> </span> Expences  
           </div>
...
<asp:Panel ID="pnlpopupAddCategoryView"  class="panel panel-primary"  runat="server" BackColor="White" style="display:none"  Width="60%" DefaultButton="btnSubmit"> 
    ...
    <div class="panel-body">    
        ...
        <br />
                      ...
                      <asp:Label ID="Label2" runat="server" Font-Size="12px"  Text="Payee"></asp:Label>
                        ...
                        <asp:TextBox  ID="TextBox1" ToolTip="Enter Payee Name" class="form-control"  ValidationGroup="vlpg43" runat="server"></asp:TextBox>
        <br />    
        ...
        <br />    
         <asp:Label ID="Label1" runat="server" Font-Size="12px"  Text="Payee Accounts Number"></asp:Label>
                        ...
                        <asp:TextBox  ID="TextBox2" ToolTip=" Payee Accounts Number" class="form-control"  ValidationGroup="vlpg43" runat="server"></asp:TextBox>
         <br /> 
