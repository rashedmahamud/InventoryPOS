...
public partial class Accounts_Income : System.Web.UI.Page
{
    ...
    public void Category()
    {
        ...
        SqlCommand cmd = new SqlCommand("Select *from Income_Category where  Branch_ID='" + ShopId + "'", con);
        cmd.CommandType = CommandType.Text;
        con.Open();
        SqlDataReader rd4 = cmd.ExecuteReader();
        ...
        if (rd4.HasRows)
        {
            ...
            while (rd4.Read())
            {
                ...
                DropDownList1.Items.Add((rd4["Income_Category"].ToString()));
    ...
    public void CategoryListDataBind()
    {
        ...
        SqlCommand cmd = new SqlCommand("Select *from Income where Status=1 and Branch_ID='" + ShopId + "'", con);
        cmd.CommandType = CommandType.Text;
        con.Open();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Income_Insert", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@category", DropDownList1.Text);
            cmd.Parameters.AddWithValue("@Payeer", TextBox1.Text);
            cmd.Parameters.AddWithValue("@ChartofAccount", DropDownList2.Text);
            cmd.Parameters.AddWithValue("@Payeer_Account_Number", TextBox2.Text);
