<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master"  AutoEventWireup="true" Inherits="ItemList" Codebehind="ItemList.aspx.cs" %>
 ...
 <br /> 
         <div class="form-group">      
                                  <div class="input-group">                               
                                        <asp:TextBox ID="txtSearch" Font-Size="15px" class="form-control" ToolTip="Search by item name... " 
                    ...
                    <ul id="plans">
                        <li class="plan"  >
                            <ul class="planContainer"> 
                                ...
                                <li class="title">
                                    <asp:Image ID="imgPhoto" runat="server" class="img-circle"  Width="96px" Height="96px"   ImageUrl='<%# Eval("Photo")%>' />
                                </li>
                                <li>
                                     <ul class="options">                                      
