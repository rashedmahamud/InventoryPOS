...
public partial class Items_SpecialItem : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd1 = new SqlCommand();
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = " SELECT COUNT(*) FROM tbl_ItemSpecial where ItemCode='" + TextBox1.Text.Trim() + "' ";
            ...
            if (RecordCount == 0)
            {
                ...
                cmd.CommandText = " Insert into tbl_ItemSpecial (ItemCode,ItemName,PurchasePrice ,RetailPrice, ItemQty,MinQty,MaxQty ,MDate,ExDate ,SupplierCode,ItemCategory,Tax, Discount,LogBy,Lastupdateby,Photo,Description,Status,Lastupdate,Logtime,ShopID)	values  	(@ItemCode,@ItemName,@PurchasePrice ,@RetailPrice, @ItemQty,@MinQty,@MaxQty ,@MDate,@ExDate ,@SupplierCode,@ItemCategory,@Tax, @Discount,@LogBy,@Lastupdateby,@Itemphoto,@Description,@Status,@Lastupdate,@Logtime,@ShopID)";
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = " UPDATE tbl_ItemSpecial SET  ItemCode=@ItemCode,ItemName=@ItemName,PurchasePrice=@PurchasePrice ,RetailPrice=@RetailPrice, ItemQty=@ItemQty,MinQty=@MinQty,MaxQty=@MaxQty ,MDate=@MDate,ExDate=@ExDate ,SupplierCode=@SupplierCode,ItemCategory=@ItemCategory,Tax=@Tax, Discount=@Discount,LogBy=@LogBy,Lastupdateby=@Lastupdateby,Photo=@Itemphoto,Description=@Description,Status=@Status,Lastupdate=@Lastupdate,Logtime=@Logtime,ShopID=@ShopID where ItemCode= '" + TextBox1.Text.Trim() + "' ";
    ...
    public void purchasedetails()
    {
        ...
        SqlCommand cmd = new SqlCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = " Insert into purchasedetails (ItemCode,ItemName,PurchasePrice ,RetailPrice, ItemQty,MinQty,MaxQty ,MDate,ExDate ,SupplierCode,ItemCategory,Tax, Discount,LogBy,Lastupdateby,Photo,Description,Status,Lastupdate,Logtime,ShopID)	values  	(@ItemCode,@ItemName,@PurchasePrice ,@RetailPrice, @ItemQty,@MinQty,@MaxQty ,@MDate,@ExDate ,@SupplierCode,@ItemCategory,@Tax, @Discount,@LogBy,@Lastupdateby,@Itemphoto,@Description,@Status,@Lastupdate,@Logtime,@ShopID)";
    ...
    void Barcodesearch()
    {
        ...
        SqlCommand cmd1 = new SqlCommand();
        cmd1.CommandType = CommandType.Text;
        cmd1.CommandText = " select *from tbl_ItemSpecial where ItemCode='" + TextBox1.Text.Trim() + "' ";
        cmd1.Connection = cn;
        cn.Open();
        SqlDataReader rd1 = cmd1.ExecuteReader();
