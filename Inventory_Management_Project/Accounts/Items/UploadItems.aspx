<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master"  AutoEventWireup="true" Inherits="Items_UploadItems" Codebehind="UploadItems.aspx.cs" %>
...
<div class="col-lg-8 ">
        <div class="well well-sm"  >
            ...
            <div class="col-lg-6" style="text-align:Right">
                <asp:HyperLink ID="hlnkAddCategory" Font-Size="20px" ForeColor="Black"  ToolTip="Add Category"  class="fa fa-plus" NavigateUrl="~/Items/AddItem.aspx"  ValidationGroup="vlpg11" runat="server"></asp:HyperLink>
                Add single item
            </div><br />
    </div>
       ...
       <div class="panel panel-primary" style="text-align:left">      
          <div class="panel-body">
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/CSVFile/csvfilesample/BulkUpload.csv" Font-Underline="True"> Download CSV file Sample</asp:HyperLink>
              <hr />
