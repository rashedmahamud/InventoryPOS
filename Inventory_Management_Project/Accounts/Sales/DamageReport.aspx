<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" Inherits="Accounts_Sales_DamageReport" Codebehind="DamageReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server"> 
  ...
  <input type="button" class="btn btn-success btn-xs"   value="Damage Report " style="width:100%;height:100px;font-size:xx-large" />  
            ...
            <div  >
                <br />
                 <div style="margin-left:30%" > 
                       ...
                       <asp:TextBox ID="txtsearch"  Visible="false"  Width="320px"   
                                ToolTip="Search by : Invoice No Or Store Number"   Placeholder="Search" runat="server" AutoPostBack="True" 
                                ontextchanged="txtsearch_TextChanged"></asp:TextBox>
                     <br /><br />
                                     Date:    <atk:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" TargetControlID="txtDateFrom" />
