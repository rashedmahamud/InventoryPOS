<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" Inherits="Accounts_Quote" Codebehind="Quote.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
                ...
                <table>
                    <tr>
                        ...
                        <td style="vertical-align:middle;text-align:left;width:33%">
                            ...
                            <br />
                            <br />
 <asp:Label ID="Label6"  runat="server" Text=" Quotation " Font-Size="50px"></asp:Label>
 ...
 <img src="../img/logo.png" style="width:150px ; height:70px ;"  />  
    	...
    	<div>
            ...
            <tr>
                <td style="width:33%;vertical-align:top"  >
                    <b style="font-size:x-large"> Quotation TO: </b><br />
    ...
    <asp:TextBox  ID="TextBox13"  class="effect-4 input-effect" Visible="false"  Height="12px" BackColor="#f0f5f5"  runat="server" type="text" Width="150px" Font-Size="10px"  placeholder="Ship To"  > </asp:TextBox>
    	    ...
    	    <td style="width:40% ;vertical-align:top;margin-left:50%"><b>Quotation #</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox14" Font-Size="10px" runat="server" Height="16px" class="effect-1 input-effect"  BackColor="#f0f5f5" placeholder="Invoice Number" type="text" Width="120px"> </asp:TextBox>
                <br />
                <b>Quotation Date : &nbsp;&nbsp;</b><asp:TextBox ID="TextBox15" Font-Size="10px" runat="server" BackColor="#f0f5f5" Height="16px"  class="effect-1 input-effect"  Enabled="false" placeholder="Invoice Date" type="text" Width="120px"> </asp:TextBox>
                <br />
