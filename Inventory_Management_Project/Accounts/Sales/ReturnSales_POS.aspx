<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master"AutoEventWireup="true" Inherits="ReturnSales_POS" Codebehind="ReturnSales_POS.aspx.cs" %> 
...
<div style="width:100%"> <h1>  <asp:Button ID="Button100"  runat="server"  Text="Inventory Return List " Width="100%"  height="50px"  ValidationGroup="vG2"  Font-Size="12px"  ToolTip="Add to Cart" class="btn btn-primary btn-xs" OnClick="btn_Goclick" />  <br />           
</h1>
