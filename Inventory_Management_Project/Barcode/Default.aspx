<%@ Page Language="C#" AutoEventWireup="true" Inherits="Barcode_Default" Codebehind="Default.aspx.cs" %>
  ...
  <head>
    ...
    <style>
      * {
      ...
      <script src="../assets/scripts/jquery-barcode.js" type="text/javascript"></script>
      <script src="../assets/scripts/jquery-barcode.min.js" type="text/javascript"></script>
      <script src="../assets/scripts/PrintBarcode.js" type="text/javascript"></script>
    ...
    <div id="generator">   
         <div class="col-lg-6">    
              <asp:TextBox ID="barcodeValue" runat="server" Text=""></asp:TextBox>    
                <input type="button" onclick="generateBarcode();" value=" Generate the barcode " class="btn btn-success btn-xs" >
        ...
        <div class="config">
          <div class="title">Type</div>
            <table>
                <tr>
                    <td>
          <input type="radio" name="btype" id="ean8" value="ean8" /></td><td><label for="ean8">EAN 8</label><br />
                        </td>
                    </tr>
