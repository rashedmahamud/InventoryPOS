<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/MasterPage.master" AutoEventWireup="true" Inherits="Customers_Order_Invoice_Customer" Codebehind="Order_Invoice_Customer.aspx.cs" %>
...
<div   class="col-lg-10 col-lg-offset-1"> <p></p>
    ...
    <div  id="AddressInfo" style="text-align:left;padding-left:15px; background-color:White">  
         ...
         <%--Received payment transaction list--%>
                ...
                <div style="text-align:center; background-color:White"      class="col-lg-12">                    
