<%@ Page Title="" Language="C#" MasterPageFile="../MasterPage/Bootstrap.master" AutoEventWireup="true" Inherits="Order_module_NewOrder" Codebehind="Copy of NewOrder.aspx.cs" %> 
...
<div class="col-lg-6"> 
    ...
    <div class="panel panel-primary" > 
            <asp:Panel ID="Panel2" runat="server" ScrollBars="Vertical" Height="270px">
                ...
                <asp:GridView ID="grdSelectedItem"   onrowdatabound="grdSelectedItem_RowDataBound" 
...
<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="355px">  <br /> 
