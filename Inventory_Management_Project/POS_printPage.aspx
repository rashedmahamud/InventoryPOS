<%@ Page Title="" Language="C#"  AutoEventWireup="true" Inherits="POS_printPage" Codebehind="POS_printPage.aspx.cs" %>
...
<div class="col-lg-3 col-lg-offset-1">
  <%--           <asp:button id="btnBack" runat="server"  class="btn btn-warning btn-xs"   Text="Back"
            ...
            <input type="button" class="btn btn-success btn-xs" value="Print"  onclick="javascript:printDiv('wrapper')" />--%>
             <asp:Label ID="Label22" Visible="false" runat="server" Text="Label"></asp:Label>
          <hr />
