<%@ Page Title="" Language="C#" MasterPageFile="../MasterPage/Bootstrap.master" AutoEventWireup="true" Inherits="Reports"  Codebehind="Reports.aspx.cs" %>
...
<div class="col-lg-12">
    <div class="well well-sm"  >
            ...
            class="btn btn-info"  PostBackUrl="~/Report/SalesReports.aspx" />
             ...
             <input type="button" class="btn btn-success" value="Print"  onclick="javascript:printDiv('wrapper')" />      
        ...
        <div class="panel panel-primary"> 
                ...
                <span style="padding-left:130px">  <asp:Label ID="lbltotalProfit" Font-Bold="true"   Font-Size="11px" runat="server" Text=""></asp:Label></span>  
                      ...
                      <asp:Panel ID="pnlContents" runat="server" ScrollBars="Vertical" Height="350px">
                          <div id="wrapper">    
                        ...
                        <asp:GridView ID="grdViewReport" runat="server" 
                         ...
                         <Columns>
                              <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>                     
                                         <asp:LinkButton ID="LinkDetails" runat="server" ForeColor="Red"  Font-Size="15px"  OnClick="LinkDetails_click"     ToolTip="Details" class="fa fa-eye"  />                                 
                                    </ItemTemplate>
                              </asp:TemplateField>                     
                              </Columns> 
                            </asp:GridView>
