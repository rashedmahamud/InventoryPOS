<%@ Page Title="" Language="C#" AutoEventWireup="true" Inherits="ReturnSales_POS" Codebehind="ReturnSales_POS.aspx.cs" %> 
...
<div style="width:100%"> 
 <h1> 
                                 <asp:Button ID="inv"  runat="server"  Text="Inventory List " Width="100%"  height="50px"  ValidationGroup="vG2"  Font-Size="12px"  BackColor="Black" ToolTip="Add to Cart" back class="btn btn-primary btn-xs" OnClick="btn_Goclick" />  <br />           
   
       
 </h1>
                          <div class="panel  panel-success">  
       
            <asp:DataList ID="DataList2" runat="server"   RepeatColumns="1" RepeatDirection="Vertical"  BorderStyle="None" CaptionAlign="Bottom" CssClass="active left" HorizontalAlign="Left"  style="vertical-align:top;text-align:left" ShowFooter="False" ShowHeader="False" CellPadding="0"  >
...
<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="300px">  <br /> 
       <asp:DataList ID="DataList1" runat="server"  RepeatColumns="8" Font-Names="Verdana" Font-Size="Small" RepeatLayout="Flow"    RepeatDirection="Horizontal" CssClass="row">
            <ItemStyle ForeColor="Black"/>
            <ItemTemplate>
                <div class="col-md-2">  
                    <div id="pricePlansmsg">
                    <ul id="plans" style="width:200px;">
                        <li class="plan">
                            <ul class="planContainer " style="width:200px;">
                                <li class="title">
                                    ...
                                    <h5><asp:Label   ID="lblitemNametop" Font-Size="12px" runat="server" Text='<%# Bind("ItemName") %>'></asp:Label></h5><br />
                                    <h5><asp:Label   ID="Label10" Font-Size="12px" runat="server" Text='<%# Bind("Description") %>'></asp:Label></h5>
                                ...
                                <li>
                                 ...
                                 <asp:Button ID="btnGo"  runat="server"  Text="Add to Cart" Width="100%"  height="50px"  ValidationGroup="vG2"  Font-Size="12px"  ToolTip="Add to Cart" BackColor="Black" class="btn btn-primary btn-xs" OnClick="btn_Goclick" />  <br />           
                            </ul>
                        </li>
                    </ul>
                </div>
...
<div style="width:100%"> <h1>  <asp:Button ID="Button100"  runat="server"  BackColor="Black" Text="Inventory Return List " Width="100%"  height="50px"  ValidationGroup="vG2"  Font-Size="12px"  ToolTip="Add to Cart" class="btn btn-primary btn-xs" OnClick="btn_Goclick" />  <br />           
</h1>
