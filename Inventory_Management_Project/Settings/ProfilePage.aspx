<%@ Page Title="" Language="C#" MasterPageFile="../MasterPage/Bootstrap.master" AutoEventWireup="true" Inherits="ProfilePage" Codebehind="ProfilePage.aspx.cs" %>
              ...
              <div class="col-lg-5">
               ...
               <div class="col-lg-5">
                       ...
                       <asp:TextBox ID="txtPassword" class="form-control" ValidationGroup="vlpg43" runat="server"></asp:TextBox>
                        ...
                        <br /><asp:Image ID="imgUser" class="img-thumbnail" Width="120" Height="120" runat="server" />
                          
                        <asp:UpdatePanel ID="UpdatePanelImageUpload" runat="server"  UpdateMode="Conditional">
                            <ContentTemplate>                                
                                 <p> <asp:FileUpload  ID="FUpimg"   class="btn btn-warning btn-xs"  runat="server"   />  </p>
                           <asp:Button ID="btnSubmit" runat="server" ValidationGroup="vlpg43" class="btn btn-primary btn-sm"   Text="Update" onclick="btnSubmit_Click" /> <br /><br />
                        </ContentTemplate>   
