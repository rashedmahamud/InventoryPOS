<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Bootstrap.master" AutoEventWireup="true" Inherits="Settings_ShopList" Codebehind="ShopList.aspx.cs" %>
...
<asp:Panel ID="pnlpopupAddCategoryView"  class="panel panel-primary"  runat="server" BackColor="White" style="display:none"  Width="400px" DefaultButton="btnSubmit"> 
    ...
    <div class="panel-footer">              
            <asp:LinkButton ID="btnCancel" runat="server"  ForeColor="#FFFFCC" class="btn btn-danger btn-sm" data-dismiss="alert" >Close</asp:LinkButton> 
