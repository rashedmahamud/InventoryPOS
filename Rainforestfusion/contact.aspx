...
<body>
    ...
    <div class="content-wrapper">
        <section id="contact_form" class="section clear">
            <div class="right">
            ...
            <div class="left section-text">
                <form action="">
                    ...
                    <input type="submit" class="submit-btn rain-btn" value="Send">
                </form>
            </div>
        </section>

        <section id="scroll_query" class="section clear">
            <div class="left">
                <img src="images/big-thumb.jpg" class="section-img" alt="">
            </div>
            <div class="right section-text">
                ...
                <ul class="rain-list">
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, porro?</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, porro?</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, porro?</li>
                </ul>
                <div class="text-link">
                    <a href="#scroll_query" class="rain-btn-2">How To Get To Quay</a>
                    <a href="#scroll_opening_hours" class="rain-btn-2">Opening Hours</a>
                    <a href="#scroll_car_parking" class="rain-btn-2">Car Parking</a>
                    <a href="#scroll_parking_rates" class="rain-btn-2">Parking Rates</a>
                </div>
            </div>
        </section>

        <section id="scroll_opening_hours" class="section clear">
            <div class="left section-text">
                <h2>OPENING HOURS</h2>
                <dl>
                    <dt>Restaurant lunch service</dt>
                    <dd>Friday, Saturday and Sunday | Bookings from 12pm to 1.30pm</dd>
                    <dt>Restaurant dinner service</dt>
                    <dd>Daily | Bookings from 6pm to 9.30pm</dd>
                    <dt>Reservations Office</dt>
                    <dd>Open from 9am to 7pm, Monday to Friday, and from 10am to 6pm, Saturday and Sunday.</dd>
                </dl>
                <div class="text-link">
                    <a href="#scroll_query" class="rain-btn-2">How To Get To Quay</a>
                    <a href="#scroll_opening_hours" class="rain-btn-2">Opening Hours</a>
        ...
        <section id="scroll_car_parking" class="section clear">
            <div class="left">
                <img src="images/big-thumb.jpg" class="section-img" alt="">
            </div>
            <div class="right section-text">
                <h2>CAR PARKING</h2>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Qui aspernatur sed modi sunt
                    <a href="#">consequatur</a> magni dicta quod repellendus, atque nemo.</p>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Qui aspernatur sed modi sunt consequatur magni dicta quod repellendus,
                                    atque nemo.</p>
                <div class="text-link">
                    <a href="#scroll_query" class="rain-btn-2">How To Get To Quay</a>
                    <a href="#scroll_opening_hours" class="rain-btn-2">Opening Hours</a>
        ...
        <section id="scroll_parking_rates" class="section clear">
            <div class="left section-text">
                <h2>PARKING RATES</h2>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Qui aspernatur sed modi sunt
                    <a href="#">consequatur</a> magni dicta quod repellendus, atque nemo.</p>
<p>Lorem ipsum dolor sit,
    <a href="#">amet</a> consectetur adipisicing elit. Qui aspernatur sed modi sunt consequatur magni dicta quod repellendus,
                    atque nemo.</p>
                <div class="text-link">
                    <a href="#scroll_query" class="rain-btn-2">How To Get To Quay</a>
                    <a href="#scroll_opening_hours" class="rain-btn-2">Opening Hours</a>
