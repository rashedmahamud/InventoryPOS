...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="section clear menu-tab">
                <ul class="nav nav-pills justify-content-center" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#home">10 Course Menu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="pill" href="#menu1">6 Course Menu</a>
                    </li>
                    <li class="nav-item">
                ...
                <div id="home" class="container tab-pane active menu-content"><br>
                    <h3>10 Course Menu</h3>
                    <div class="menu-item">
                        <dl>
                            <dt>Pea garden</dt>
                            <dd>miso, anchovy</dd>
                    ...
                    <div class="menu-item">
                        <dl>
                            <dt>Hand harvested seafood</dt>
                            <dd>virgin soy, seaweed, aged vinegar</dd>
                        </dl>
                    </div>
                </div>
                <div id="menu1" class="container tab-pane fade menu-content"><br>
                    <h3>6 Course Menu</h3>
                    <div class="menu-item">
                        <dl>
                            <dt>Hand harvested seafood</dt>
                    ...
                    <div class="menu-item">
                        <dl>
                            <dt>Sand crab</dt>
                            <dd>Tennouji turnip, kombu, squid Wakefield cabbage</dd>
                        </dl>
                    </div>
                </div>
                <div id="menu2" class="container tab-pane fade menu-content"><br>
                    <h3>Drinks</h3>
                    <ul>
